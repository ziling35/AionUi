...
const SiderItem: React.FC<SiderItemProps> = ({
  ...
  const showNameTooltip = !!name && !isMobile && nameOverflowing;

  React.useLayoutEffect(() => {
    updateNameOverflowState();
  }, [name, updateNameOverflowState]);
  ...
  return (
    ...
    >
      ...
      <Tooltip
        content={renderTitleTooltipContent(name)}
        disabled={!showNameTooltip}
        trigger='hover'
        popupVisible={showNameTooltip ? undefined : false}
        unmountOnExit
